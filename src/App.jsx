...
const themes = {
  slate: {
    ...
    tabInactive: 'bg-slate-600/80 text-slate-200',
  },
  sage: {
    name: 'Sage',
    bg: 'bg-stone-700',
    bgSecondary: 'bg-stone-600',
    bgTertiary: 'bg-stone-500',
    border: 'border-stone-500',
    text: 'text-white',
    textMuted: 'text-stone-200',
    textSubtle: 'text-stone-300',
    accent: 'bg-stone-500',
    accentHover: 'hover:bg-stone-400',
    accentText: 'text-stone-200',
    tabActive: 'bg-white text-stone-700',
    tabInactive: 'bg-stone-500/80 text-stone-200',
  },
  dustyRose: {
    name: 'Dusty Rose',
    bg: 'bg-rose-900/70',
    bgSecondary: 'bg-rose-800/60',
    bgTertiary: 'bg-rose-700/50',
    border: 'border-rose-700/50',
    text: 'text-white',
    textMuted: 'text-rose-100',
    textSubtle: 'text-rose-200',
    accent: 'bg-rose-600/60',
    accentHover: 'hover:bg-rose-500/60',
    accentText: 'text-rose-200',
    tabActive: 'bg-white text-rose-900',
    tabInactive: 'bg-rose-700/50 text-rose-100',
  },
  warmGray: {
    name: 'Warm Gray',
    bg: 'bg-zinc-700',
    bgSecondary: 'bg-zinc-600',
    bgTertiary: 'bg-zinc-500',
    border: 'border-zinc-500',
    text: 'text-white',
    textMuted: 'text-zinc-200',
    textSubtle: 'text-zinc-300',
    accent: 'bg-zinc-500',
    accentHover: 'hover:bg-zinc-400',
    accentText: 'text-zinc-200',
    tabActive: 'bg-white text-zinc-700',
    tabInactive: 'bg-zinc-500/80 text-zinc-200',
  },
  seafoam: {
    name: 'Seafoam',
    bg: 'bg-cyan-900/70',
    bgSecondary: 'bg-cyan-800/60',
    bgTertiary: 'bg-cyan-700/50',
    border: 'border-cyan-700/50',
    text: 'text-white',
    textMuted: 'text-cyan-100',
    textSubtle: 'text-cyan-200',
    accent: 'bg-cyan-600/60',
    accentHover: 'hover:bg-cyan-500/60',
    accentText: 'text-cyan-200',
    tabActive: 'bg-white text-cyan-900',
    tabInactive: 'bg-cyan-700/50 text-cyan-100',
  },
};
